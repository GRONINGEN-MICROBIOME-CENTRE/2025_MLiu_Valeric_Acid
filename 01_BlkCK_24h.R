...
# ----------------------------------------------------------------------------------------------------------------------
# DEG
metadata_BlkCK_24h <- subset(metadata_BlkCK, Timepoint == 24)
count_data_BlkCK_24h <- count_data_BlkCK[, rownames(metadata_BlkCK_24h)]
# DGE
metadata <- metadata_BlkCK_24h
count_data <- count_data_BlkCK_24h
...
write.csv(deg_results_df, file = "../results/Orga_bulkrna/VA_0810/DEG_results_Cytokines_24h.csv", row.names=TRUE)
...
ggsave(filename = "../results/Orga_bulkrna/VA_0810/01_BlkCK/PCA_BlkCK_24h.pdf", plot = pp, width = 8, height = 6, dpi = 300)
...
ggsave(filename = "../results/Orga_bulkrna/VA_0810/01_BlkCK/Volcano_BlkCK_24h.pdf", plot = pv, width = 7, height = 6, dpi = 300)
 ### Heatmap
# 提取显著差异基因
...
ggsave(filename = "../results/Orga_bulkrna/VA_0810/01_BlkCK/Heatmap_BlkCK_24h.pdf", plot = ph, width = 8, height = 6, dpi = 300)
...
ggsave(filename = "../results/Orga_bulkrna/VA_0810/01_BlkCK/KEGGup_BlkCK_24h.pdf", plot = pkegg_up, width = 8, height = 8, dpi = 300)
# 下调基因
...
ggsave(filename = "../results/Orga_bulkrna/VA_0810/01_BlkCK/KEGGdown_BlkCK_24h.pdf", plot = pkegg_down, width = 8, height = 8, dpi = 300)
