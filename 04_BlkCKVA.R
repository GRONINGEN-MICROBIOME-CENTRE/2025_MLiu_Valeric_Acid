...
write.csv(deg_results_df, file = "../results/Orga_bulkrna/VA_0810/05_BlkCKVA/DEG_results_VA_nopretreat_0.3mM_6h.csv", row.names=TRUE)
...
ggsave(filename = "../results/Orga_bulkrna/VA_0810/05_BlkCKVA/PCA_VA_nopretreat_0.3mM_6h.pdf", plot = pp, width = 8, height = 6, dpi = 300)
...
ggsave(filename = "../results/Orga_bulkrna/VA_0810/05_BlkCKVA/Volcano_VA_nopretreat_0.3mM_6h.pdf", plot = pv, width = 7, height = 6, dpi = 300)
### Heatmap
# 提取显著差异基因
...
ggsave(filename = "../results/Orga_bulkrna/VA_0810/05_BlkCKVA/Heatmap_VA_nopretreat_0.3mM_6h.pdf", plot = ph, width = 8, height = 6, dpi = 300)
...
ggsave(filename = "../results/Orga_bulkrna/VA_0810/05_BlkCKVA/KEGGup_VA_nopretreat_0.3mM_6h.pdf", plot = pkegg_up, width = 8, height = 8, dpi = 300)
# 下调基因
...
ggsave(filename = "../results/Orga_bulkrna/VA_0810/05_BlkCKVA/KEGGdown_VA_nopretreat_0.3mM_6h.pdf", plot = pkegg_down, width = 8, height = 8, dpi = 300)
