...
metadata_VA_CKnopretreat_1mM_6h <- read.csv("../results/Orga_bulkrna/04_CKCKVA/metadata_VA_CKnopretreat_1mM_6h.csv", header = TRUE, row.names = 1)
count_data_VA_CKnopretreat_1mM_6h <- count_data[, rownames(metadata_VA_CKnopretreat_1mM_6h), drop = FALSE]

metadata_VA_CKnopretreat_3mM_6h <- read.csv("../results/Orga_bulkrna/04_CKCKVA/metadata_VA_CKnopretreat_3mM_6h.csv", header = TRUE, row.names = 1)
count_data_VA_CKnopretreat_3mM_6h <- count_data[, rownames(metadata_VA_CKnopretreat_3mM_6h), drop = FALSE]

metadata_VA_CKnopretreat_10mM_6h <- read.csv("../results/Orga_bulkrna/04_CKCKVA/metadata_VA_CKnopretreat_10mM_6h.csv", header = TRUE, row.names = 1)
count_data_VA_CKnopretreat_10mM_6h <- count_data[, rownames(metadata_VA_CKnopretreat_10mM_6h), drop = FALSE]

run_ckva_basic(count_data_VA_CKnopretreat_0.3mM_6h, metadata_VA_CKnopretreat_0.3mM_6h,
               conc_label = "0.3", time_label = "6h",
               out_dir = "../results/Orga_bulkrna/VA_0810/03_CKCKVA",
               prefix  = "VA_CKnopretreat")

run_ckva_basic(count_data_VA_CKnopretreat_1mM_6h, metadata_VA_CKnopretreat_1mM_6h,
               conc_label = "1", time_label = "6h",
               out_dir = "../results/Orga_bulkrna/VA_0810/03_CKCKVA",
               prefix  = "VA_CKnopretreat")

run_ckva_basic(count_data_VA_CKnopretreat_3mM_6h, metadata_VA_CKnopretreat_3mM_6h,
               conc_label = "3", time_label = "6h",
               out_dir = "../results/Orga_bulkrna/VA_0810/03_CKCKVA",
               prefix  = "VA_CKnopretreat")

run_ckva_basic(count_data_VA_CKnopretreat_10mM_6h, metadata_VA_CKnopretreat_10mM_6h,
...
####################################
# 24h
metadata_VA_CKnopretreat_0.3mM_24h <- read.csv("../results/Orga_bulkrna/04_CKCKVA/metadata_VA_CKnopretreat_0.3mM_24h.csv", header = TRUE, row.names = 1)
count_data_VA_CKnopretreat_0.3mM_24h <- count_data[, rownames(metadata_VA_CKnopretreat_0.3mM_24h), drop = FALSE]

metadata_VA_CKnopretreat_1mM_24h <- read.csv("../results/Orga_bulkrna/04_CKCKVA/metadata_VA_CKnopretreat_1mM_24h.csv", header = TRUE, row.names = 1)
count_data_VA_CKnopretreat_1mM_24h <- count_data[, rownames(metadata_VA_CKnopretreat_1mM_24h), drop = FALSE]

metadata_VA_CKnopretreat_3mM_24h <- read.csv("../results/Orga_bulkrna/04_CKCKVA/metadata_VA_CKnopretreat_3mM_24h.csv", header = TRUE, row.names = 1)
count_data_VA_CKnopretreat_3mM_24h <- count_data[, rownames(metadata_VA_CKnopretreat_3mM_24h), drop = FALSE]

metadata_VA_CKnopretreat_10mM_24h <- read.csv("../results/Orga_bulkrna/04_CKCKVA/metadata_VA_CKnopretreat_10mM_24h.csv", header = TRUE, row.names = 1)
count_data_VA_CKnopretreat_10mM_24h <- count_data[, rownames(metadata_VA_CKnopretreat_10mM_24h), drop = FALSE]

run_ckva_basic(count_data_VA_CKnopretreat_0.3mM_24h, metadata_VA_CKnopretreat_0.3mM_24h,
               conc_label = "0.3", time_label = "24h",
               out_dir = "../results/Orga_bulkrna/VA_0810/03_CKCKVA",
               prefix  = "VA_CKnopretreat")

run_ckva_basic(count_data_VA_CKnopretreat_1mM_24h, metadata_VA_CKnopretreat_1mM_24h,
               conc_label = "1", time_label = "24h",
               out_dir = "../results/Orga_bulkrna/VA_0810/03_CKCKVA",
               prefix  = "VA_CKnopretreat")

run_ckva_basic(count_data_VA_CKnopretreat_3mM_24h, metadata_VA_CKnopretreat_3mM_24h,
               conc_label = "3", time_label = "24h",
               out_dir = "../results/Orga_bulkrna/VA_0810/03_CKCKVA",
               prefix  = "VA_CKnopretreat")

run_ckva_basic(count_data_VA_CKnopretreat_10mM_24h, metadata_VA_CKnopretreat_10mM_24h,
...
#----------------------------------------------------------------------------------------------------------------------------
# 1h 预处理 6h
metadata_VA_CK1hpretreat_0.3mM_6h <- read.csv("../results/Orga_bulkrna/04_CKCKVA/metadata_VA_CK1hpretreat_0.3mM_6h.csv", header = TRUE, row.names = 1)
count_data_VA_CK1hpretreat_0.3mM_6h <- count_data[, rownames(metadata_VA_CK1hpretreat_0.3mM_6h), drop = FALSE]

metadata_VA_CK1hpretreat_1mM_6h <- read.csv("../results/Orga_bulkrna/04_CKCKVA/metadata_VA_CK1hpretreat_1mM_6h.csv", header = TRUE, row.names = 1)
count_data_VA_CK1hpretreat_1mM_6h <- count_data[, rownames(metadata_VA_CK1hpretreat_1mM_6h), drop = FALSE]

metadata_VA_CK1hpretreat_3mM_6h <- read.csv("../results/Orga_bulkrna/04_CKCKVA/metadata_VA_CK1hpretreat_3mM_6h.csv", header = TRUE, row.names = 1)
count_data_VA_CK1hpretreat_3mM_6h <- count_data[, rownames(metadata_VA_CK1hpretreat_3mM_6h), drop = FALSE]

metadata_VA_CK1hpretreat_10mM_6h <- read.csv("../results/Orga_bulkrna/04_CKCKVA/metadata_VA_CK1hpretreat_10mM_6h.csv", header = TRUE, row.names = 1)
count_data_VA_CK1hpretreat_10mM_6h <- count_data[, rownames(metadata_VA_CK1hpretreat_10mM_6h), drop = FALSE]

run_ckva_basic(count_data_VA_CK1hpretreat_0.3mM_6h, metadata_VA_CK1hpretreat_0.3mM_6h,
               conc_label = "0.3", time_label = "6h",
               out_dir = "../results/Orga_bulkrna/VA_0810/04_CK1hCKVA",
               prefix  = "VA_CK1hpretreat")

run_ckva_basic(count_data_VA_CK1hpretreat_1mM_6h, metadata_VA_CK1hpretreat_1mM_6h,
               conc_label = "1", time_label = "6h",
               out_dir = "../results/Orga_bulkrna/VA_0810/04_CK1hCKVA",
               prefix  = "VA_CK1hpretreat")

run_ckva_basic(count_data_VA_CK1hpretreat_3mM_6h, metadata_VA_CK1hpretreat_3mM_6h,
               conc_label = "3", time_label = "6h",
               out_dir = "../results/Orga_bulkrna/VA_0810/04_CK1hCKVA",
               prefix  = "VA_CK1hpretreat")

run_ckva_basic(count_data_VA_CK1hpretreat_10mM_6h, metadata_VA_CK1hpretreat_10mM_6h,
               conc_label = "10", time_label = "6h",
               out_dir = "../results/Orga_bulkrna/VA_0810/04_CK1hCKVA",
               prefix  = "VA_CK1hpretreat")
...
#######################################
# 24h
metadata_VA_CK1hpretreat_0.3mM_24h <- read.csv("../results/Orga_bulkrna/04_CKCKVA/metadata_VA_CK1hpretreat_0.3mM_24h.csv", header = TRUE, row.names = 1)
count_data_VA_CK1hpretreat_0.3mM_24h <- count_data[, rownames(metadata_VA_CK1hpretreat_0.3mM_24h), drop = FALSE]

metadata_VA_CK1hpretreat_1mM_24h <- read.csv("../results/Orga_bulkrna/04_CKCKVA/metadata_VA_CK1hpretreat_1mM_24h.csv", header = TRUE, row.names = 1)
count_data_VA_CK1hpretreat_1mM_24h <- count_data[, rownames(metadata_VA_CK1hpretreat_1mM_24h), drop = FALSE]

metadata_VA_CK1hpretreat_3mM_24h <- read.csv("../results/Orga_bulkrna/04_CKCKVA/metadata_VA_CK1hpretreat_3mM_24h.csv", header = TRUE, row.names = 1)
count_data_VA_CK1hpretreat_3mM_24h <- count_data[, rownames(metadata_VA_CK1hpretreat_3mM_24h), drop = FALSE]

metadata_VA_CK1hpretreat_10mM_24h <- read.csv("../results/Orga_bulkrna/04_CKCKVA/metadata_VA_CK1hpretreat_10mM_24h.csv", header = TRUE, row.names = 1)
count_data_VA_CK1hpretreat_10mM_24h <- count_data[, rownames(metadata_VA_CK1hpretreat_10mM_24h), drop = FALSE]

run_ckva_basic(count_data_VA_CK1hpretreat_0.3mM_24h, metadata_VA_CK1hpretreat_0.3mM_24h,
               conc_label = "0.3", time_label = "24h",
               out_dir = "../results/Orga_bulkrna/VA_0810/04_CK1hCKVA",
               prefix  = "VA_CK1hpretreat")

run_ckva_basic(count_data_VA_CK1hpretreat_1mM_24h, metadata_VA_CK1hpretreat_1mM_24h,
               conc_label = "1", time_label = "24h",
               out_dir = "../results/Orga_bulkrna/VA_0810/04_CK1hCKVA",
               prefix  = "VA_CK1hpretreat")

run_ckva_basic(count_data_VA_CK1hpretreat_3mM_24h, metadata_VA_CK1hpretreat_3mM_24h,
               conc_label = "3", time_label = "24h",
               out_dir = "../results/Orga_bulkrna/VA_0810/04_CK1hCKVA",
               prefix  = "VA_CK1hpretreat")

run_ckva_basic(count_data_VA_CK1hpretreat_10mM_24h, metadata_VA_CK1hpretreat_10mM_24h,
               conc_label = "10", time_label = "24h",
               out_dir = "../results/Orga_bulkrna/VA_0810/04_CK1hCKVA",
               prefix  = "VA_CK1hpretreat")
